...
function List() {
    ...
    return (
        <>
            ...
            <div className='z-10 absolute justify-center top-[270px] mx-[80px] flex flex-wrap gap-2'>
            <br />

                <div className='mt-8 transition ease-in-out w-[160px] mt-[70px] mx-4 delay-300 cursor-pointer hover:scale-110 '>
